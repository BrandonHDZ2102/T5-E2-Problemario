...
public class MetodoDeCorrelacion2 {
    ...
    public static void main(String[] args) {
        // Datos de ejemplo
        double[] xData = {0.5, 1.5, 2.5, 3.5, 4.5};
        double[] yData = {1, 4, 6, 3, 2};

        // Valor a interpolar
        double xInterpolar = 2.75;
...
//ENTRADA
//0.5, 1.5, 2.5, 3.5, 4.5; // Datos de x
//1, 4, 6, 3, 2; // Datos de y
//2.75; // Valor a interpolar

//SALIDA (RESULTADO)
//El valor interpolado de y para x = 2.75 es 4.5